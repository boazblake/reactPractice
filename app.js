...
function app() {
   ...
   var ListingGrid = _react2.default.createClass({
      ...
      _getListingsJSX: function _getListingsJSX(listings) {
         ...
         for (var i = 0; i < listings.length; i++) {
            ...
            var component = _react2.default.createElement(Listing, { listingData: listingObj });
   ...
   var Listing = _react2.default.createClass({
      ...
      render: function render() {
         ...
         return _react2.default.createElement(
            "div",
            { className: "listing" },
            _react2.default.createElement("img", { src: this.props.listingData.imgURL }),
            _react2.default.createElement(
               "p",
               { className: "title" },
               "title is: ",
   ...
   _reactDom2.default.render(_react2.default.createElement(AppView, { shopData: ironData }), document.querySelector('.container'));
}
